    ...
    <body class="bg-light">
        ...
        <div class="container py-5">
            ...
            <div class="d-flex  d-flex justify-content-end gap-2 align-items-center mb-3">
                <form class="d-flex align-items-center gap-2" method="get" action="${pageContext.request.contextPath}/display">
                                ...
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3 d-flex justify-content-start gap-2">
                                            <a href="${pageContext.request.contextPath}/display?view=detail&id=${p.id}" class="btn btn-primary btn-sm">View detail</a><!--
                    ...
                    <ul class="pagination justify-content-center">
                        <c:forEach var="i" begin="1" end="${totalPages}">
                            <li class="page-item ${i == page ? 'active' : ''}">
                                <a class="page-link" href="${pageContext.request.contextPath}/display?view=list&page=${i}">${i}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </nav>
